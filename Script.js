...
<html lang="en">
  <head>
    <!-- Add necessary imports and styles from Code 1 and Code 2 -->
...
:root{
    --bg: linear-gradient(to left, #33ccff 0%, #cc66ff 100%);
...
.switch:checked+label:after {
  ...
  <body>
      ...
      <!-- ... -->
        ...
        <div class="signin-signup">
          ...
          <form action="#" class="sign-in-form">
            ...
            <a href="#" style="color: rgb(205, 197, 197);">Forget Password ?</a>
            <p class="social-text" style="color: aliceblue ;">Join us in social media platforms</p>
            ...
            <h3 style="color:aliceblue; font-weight: bolder; font-family: Georgia, 'Times New Roman', Times, serif; text-align: center; border-bottom: 2px solid aliceblue;">Enable Dark mode</h3>
          ...
          <form action="#" class="sign-up-form">
            ...
            <p class="social-text" style="color: aliceblue;">Join us in various  social media platforms</p>
            <div class="social-media">
            ...
            <br>
            <label for="switch">
              <input type="text" id="switch" class="switch" >
              <label for="switch"></label>
        </label>
          </form>
        </div>
    ...
    <script>
      // ... (sign-in-form and sign-up-form event listeners from Code 2)

      // Add fetch requests for /signup and /signin
